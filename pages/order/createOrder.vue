	...
	<view>
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">嗨豆</text>
				<text class="cell-tip">2.01254</text>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">订单金额</text>
				<text class="cell-tip red">0.05</text>
			</view>
		...
		<view class="mask" :class="maskState===0 ? 'none' : maskState===1 ? 'show' : ''" @click="toggleMask">
			<view class="mask-content" @click.stop.prevent="stopPrevent">
				...
				<view class="coupon-item">
					<view class="con">
						<view class="left">
							<text class="title">本月剩余手续费减免额</text>
						</view>
						<view class="right">
					...
					<view class="con">
						<view class="left">
							<text class="title">本订单应付手续费</text>
						</view>
						<view class="right">
